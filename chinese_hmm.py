...
# training data
with open("CTBtrainingset.txt", 'r') as f:
    training_corpus = f.readlines()
with open("CTBtrainingset_vocab.txt", 'r') as f:
    voc_l = f.read().split('\n')
vocab={}
...
# 中文tagging
with open("CTBtagtrainingset.txt", 'r') as f:
    training_corpus = f.readlines()
with open("PeopleDaily199801_taggedwords.txt", 'r') as f:
    training_corpus += f.readlines()
with open("CTBtagtrainingset_vocab.txt", 'r') as f:
    voc_l = f.read().split('\n')
